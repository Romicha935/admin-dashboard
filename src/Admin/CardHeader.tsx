...
const CardHeader = () => {
  const statsCards = [
    { title: "Total MRR", value: "$284", change: "+12.5%", color: "bg-blue-100" },
    { title: "New MRR", value: "$184", change: "+12.5%", color: "bg-orange-100" },
    { title: "Churn MRR", value: "$54", change: "+12.5%", color: "bg-purple-100" },
    { title: "Net Expansion MRR", value: "$284", change: "+12.5%", color: "bg-indigo-100" },
    { title: "Customer Churn Rate", value: "$28", change: "+12.5%", color: "bg-cyan-100" },
  ];
