                  ...
                  >
                    <td className="px-4 py-4">
                      <input
                        ...
                        className="w-4 h-4 rounded appearance-none border border-gray-400 checked:bg-blue-600 checked:border-blue-600 cursor-pointer"
                      />
                    </td>
                    <td className="px-4 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-full bg-gradient-to-br from-orange-300 to-orange-400 flex-shrink-0"></div>
                    ...
                    <td className="px-4 py-4">
                      <button className="px-4 py-1.5 text-sm font-medium text-[#171C35] bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                        View
                      </button>
                    </td>
                  </tr>
